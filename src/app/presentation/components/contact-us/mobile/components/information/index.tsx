...
const Information = () => {
    ...
    return(
        <div className="w-full h-fit bg-[#211E3B] relative rounded-lg p-8 flex flex-col justify-start items-start gap-3">
            <p className="text-white text-[15px] font-semibold">Información de Contacto</p>
