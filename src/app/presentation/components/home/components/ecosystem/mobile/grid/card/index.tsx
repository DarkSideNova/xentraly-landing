...
const Card: React.FC<cardPropsType> = ({ card }) => {
    ...
    return (
        <div className="w-full h-fit relative group">
            <div className="w-[300px] h-[225px] absolute flex flex-col justify-start items-center left-0 top-0 p-8 gap-5">
